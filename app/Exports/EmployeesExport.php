...
class EmployeesExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    ...
    public function __construct()
    {
        ...
        $this->rows = $employees->map(function (Employee $emp) use ($genderMap, $maritalMap, $sourceMap, $surveyDates) {
            ...
            return [
                ...
                'approved_at' => $emp->approved_at ? Carbon::parse($emp->approved_at)->format('Y-m-d H:i') : '',
